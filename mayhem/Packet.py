...
class Packet:
    def __init__(self, from_id=0, to_id=0,
                 player_pos=Vec3(0, 0, 0), player_velocity=Vec3(0, 0, 0), player_acceleration=Vec3(0, 0, 0),
                 player_rotation=Vec3(0, 0, 0), player_rotation_velocity = Vec3(0, 0, 0), player_rotation_acceleration = Vec3(0, 0, 0),
                 bullet_pos=Vec3(0, 0, 0), bullet_velocity=Vec3(0, 0, 0), bullet_acceleration=Vec3(0, 0, 0),
                 bullet_rotation=Vec3(0, 0, 0), bullet_rotation_velocity = Vec3(0, 0, 0), bullet_rotation_acceleration = Vec3(0, 0, 0),
                 killed_by=0):

        PacketTuple = namedtuple("Packet", ["from_id", "to_id",
                                            "player_pos", "player_velocity", "player_acceleration",
                                            "player_rotation", "player_rotation_velocity", "player_rotation_acceleration",
                                            "bullet_pos", "bullet_velocity", "bullet_acceleration",
                                            "bullet_rotation", "bullet_rotation_velocity", "bullet_rotation_acceleration",
                                            "killed_by"])
    ...
    def player_to_packet(self, p: Player, b: Bullet = Bullet(), killed_by=0) -> tuple:
        packet = Packet(
            ...
            b.rotation, b.rotation_velocity, b.rotation_acceleration,
            killed_by
            )
